		...
		\begin{column}{0.99\textwidth}
			\begin{columns}[t]
				...
				\begin{block}{\large 4 The BrainScaleS system}
					...
					\begin{adjustwidth}{1cm}{1cm}
					As such it can emulate networks of spiking neurons with \boldmath{$10^4$}\textbf{-fold speed-up} compared to biological real-time, but suffers from considerable variability of neuron parameters (Fig-B-C).
